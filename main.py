...
def trig_factory(n, m, L, H, periods=1, rows_x=10, rows_y=10):
    ...
    u = lambda x, y, area: np.sin(n*2*math.pi*x/L)*np.cos(m*2*math.pi*y/H)
    period_x = L/n
    period_y = H/m
...
if __name__ == '__main__':
    ...
    actual = lambda x, y, area: (x**4-4*x**3+4*x**2)*(y**4-4*y**3+4*y**2) - (64/225)/area
    ...
    p3 = trig_factory(3, 4, 20, 15)
    p4 = trig_factory(4, 2, 10, 10)
